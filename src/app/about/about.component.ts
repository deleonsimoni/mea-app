...
import { Curriculum } from '@app/models';
...
export class AboutComponent {
  ...
  //     titulo:
  //       ' A cibercultura na era das redes sociais e da mobilidade: novas potencialidades para a formação de professores e pesquisadores em programas de pós-graduação online.',
  ...
  //     atividades: [
  //       {
  //         data: '04/2006 - 03/2007',
  //         atividade: 'Pesquisa e desenvolvimento , Faculdade de Educação',
  //         obs: 'Linhas de pesquisa Linguagem e formação de professores.'
  //       },
  //       {
  //         data: '04/2006 - 03/2007',
  //         atividade: 'Ensino, Educação, Nível: Pós-Graduação',
  //         obs:
  //           'Disciplinas ministradas Pesquisa-Formação e Cartografia Cognitiva, Informática na Educação Prensencial e a Distância'
  //       },
  //       {
  //         data: '04/2006 - 03/2007',
  //         atividade: 'Serviços técnicos especializados , Faculdade de Educação',
  //         obs:
  //           'Serviço realizado - Consultoria para criação/atualização do site do programa e criação de páginas e AVA com alguns professores do programa.'
  //       }
  //     ]
  //   }
  // ];
  ...
  //     integrantes:
  //       'Integrantes: Edméa Oliveira dos Santos - Coordenador / Vivian Martins Lopes de Souza - Integrante / Wallace Almeida - Integrante / Frieda Marti - Integrante / Michelle Trancoso - Integrante / Joelma Almeida - Integrante.',
  //     estatus: 'Situação - Em andamento | Natureza - Pesquisa.'
  //   },
  //   {
  //     data: '2017',
  //     titulo:
  //       '88881.157953/2017-01- Promob - Fapitec/Capes. Desafios para a pesquisa, a formação docente e as aprendizagens ns educação básica na cibercultura em tempo de app-learning',
